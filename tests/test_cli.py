...
class TestCommandLineTools(unittest.TestCase):
    ...
    def test_find_tool(self) -> None:
        ...
        UtilFunctions.run_find_tool(service_names=["headstand"], allow_unknown_bit_lengths=True, no_details=True)
        # UtilFunctions.run_find_tool(service_names="3e00")
        # UtilFunctions.run_find_tool(service_names="3E 00", decode_data=True)
        # UtilFunctions.run_find_tool(service_names="3E 00", ecu_variants=["somersault_lazy"])
        # UtilFunctions.run_find_tool(service_names="3E 00")
